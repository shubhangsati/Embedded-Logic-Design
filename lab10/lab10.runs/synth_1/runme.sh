...
HD_PWD='/home/shubhang/eldlabs/lab10/lab10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_block_design_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source PWM_block_design_wrapper.tcl
