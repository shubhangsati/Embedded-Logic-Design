...
HD_PWD='/home/shubhang/eldlabs/lab10/lab10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_block_design_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source PWM_block_design_wrapper.tcl -notrace
