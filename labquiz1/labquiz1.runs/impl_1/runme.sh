...
HD_PWD='/home/shubhang/ELD/labquiz1/labquiz1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log scholarship.vdi -applog -m64 -messageDb vivado.pb -mode batch -source scholarship.tcl -notrace
