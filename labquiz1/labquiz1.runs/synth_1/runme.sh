...
HD_PWD='/home/shubhang/ELD/labquiz1/labquiz1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scholarship.vds -m64 -mode batch -messageDb vivado.pb -notrace -source scholarship.tcl
