...
HD_PWD='/home/shubhang/ELD/fulladder/fulladder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fourbitoperator.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fourbitoperator.tcl
