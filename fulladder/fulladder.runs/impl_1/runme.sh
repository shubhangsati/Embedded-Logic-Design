...
HD_PWD='/home/shubhang/ELD/fulladder/fulladder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fourbitoperator.vdi -applog -m64 -messageDb vivado.pb -mode batch -source fourbitoperator.tcl -notrace
