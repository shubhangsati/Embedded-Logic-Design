...
HD_PWD='/home/shubhang/lab2_behavioral/lab2_behavioral.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log problem1_behavioral.vds -m64 -mode batch -messageDb vivado.pb -notrace -source problem1_behavioral.tcl
