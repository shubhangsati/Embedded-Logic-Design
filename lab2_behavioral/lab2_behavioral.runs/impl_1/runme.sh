...
HD_PWD='/home/shubhang/lab2_behavioral/lab2_behavioral.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log problem1_behavioral.vdi -applog -m64 -messageDb vivado.pb -mode batch -source problem1_behavioral.tcl -notrace
