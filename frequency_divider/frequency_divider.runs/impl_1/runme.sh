...
HD_PWD='/home/shubhang/ELD/frequency_divider/frequency_divider.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top3.vdi -applog -m64 -messageDb vivado.pb -mode batch -source top3.tcl -notrace
