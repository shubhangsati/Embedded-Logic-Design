...
HD_PWD='/home/shubhang/ELD/frequency_divider/frequency_divider.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top3.vds -m64 -mode batch -messageDb vivado.pb -notrace -source top3.tcl
