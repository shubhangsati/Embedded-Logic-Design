...
compile()
{
  ...
  ncvhdl -work xbip_dsp48_macro_v3_0_11 $opts_vhd \
...
elaborate()
{
  ...
  libs="-libname secureip -libname xbip_dsp48_wrapper_v3_0_4 -libname xbip_utils_v3_0_5 -libname xbip_pipe_v3_0_1 -libname xbip_dsp48_macro_v3_0_11 -libname xil_defaultlib"
  ncelab $opts xil_defaultlib.xbip_dsp48_macro_1 $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.xbip_dsp48_macro_1 -input simulate.do
}
# Script usage
usage()
{
